...
$remove_from_allrequests="delete from allrequests where category='friend_request' and email_id_requester='$the_friend_requester_email'";var_dump($remove_from_allrequests);
