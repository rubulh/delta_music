    ...
    if($_POST['huh']='guest')
      ...
      if(mysqli_affected_rows($connection_logger)==1)
       {;;//might be useful to set any statements
        ...
        $query_logger_get_id_nick_nick_basic="select kick_guests_basic from where nick='$querynick' and login_timestamp=$querylogin_timestamp and email_id=$queryemail"; 
