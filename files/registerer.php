...
NOTE THAT REGISTERER SETS THE LOGOUT TIME NAD SUCH LOGOUT FIELDS INITIALLY TO LOGIN TIME ;
THESE TIMES LL ONLY BE UPDATED BY THE THE UNLOGGER OR THE LOGOUT FUNCTIONS
BUT IN THE MEANTIMES ALL REQUEST TIMINGS SHALL BE WRITTEN DOWN INTO THE LOG FILES
1.THE USER SPECIFIC LOG FILE SHALL HAVE COMPLETE DETAILS
2.THE DATE SPECIFIC LOG FILE SHALL HAVE THE SESSION ID AND THE CORRESSOPNDING SESSION ID NAD OTHER DETAILS
-->
...
$session_id__registerer='just_registered';//this is just registered but the logger script will set the sessionid to the current id and bygone session id accordingly
